...
namespace SWallet.Domain.Migrations
{
    ...
    [Migration("20250407155616_InitialCreate2")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SWallet.Domain.Models.CampusLecturer", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(26)
                        .IsUnicode(false)
                    ...
                    b.ToTable("campus_lecturer", (string)null);
                });
            ...
            modelBuilder.Entity("SWallet.Domain.Models.ChallengeTransaction", b =>
                {
                    ...
                    b.HasIndex("ChallengeId", "StudentId");
            ...
            modelBuilder.Entity("SWallet.Domain.Models.LuckyPrize", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("luckyPrize", (string)null);
                });
            ...
            modelBuilder.Entity("SWallet.Domain.Models.PointPackage", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(26)
                        .IsUnicode(false)
                    ...
                    b.HasKey("Id")
                        .HasName("PK_Point_package");

                    b.ToTable("point_package", (string)null);
                });
            ...
            modelBuilder.Entity("SWallet.Domain.Models.QrCodeHistory", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(26)
                        .IsUnicode(false)
                    ...
                    b.Property<DateTime>("StartOnTime")
                        .HasColumnType("datetime2")
                        .HasColumnName("startOnTime");

                    b.HasKey("Id");

                    b.ToTable("qr_code_history", (string)null);
                });

            modelBuilder.Entity("SWallet.Domain.Models.QrcodeUsage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<string>("QrcodeJson")
                        .HasColumnType("nvarchar(max)")
                        .HasColumnName("qrcode_json");
                    ...
                    b.ToTable("qrcode_usage", (string)null);
                });
            ...
            modelBuilder.Entity("SWallet.Domain.Models.StudentChallenge", b =>
                {
                    ...
                    b.HasKey("ChallengeId", "StudentId");
            ...
            modelBuilder.Entity("SWallet.Domain.Models.CampusLecturer", b =>
                {
                    b.HasOne("SWallet.Domain.Models.Campus", "Campus")
                        .WithMany("CampusLecturers")
                        .HasForeignKey("CampusId")
                        .HasConstraintName("FK_campus_lecturer_campus");

                    b.HasOne("SWallet.Domain.Models.Lecturer", "Lecturer")
                        .WithMany("CampusLecturers")
            ...
            modelBuilder.Entity("SWallet.Domain.Models.ChallengeTransaction", b =>
                {
                    ...
                    b.HasOne("SWallet.Domain.Models.StudentChallenge", "StudentChallenge")
                        .WithMany("ChallengeTransactions")
                        .HasForeignKey("ChallengeId", "StudentId")
                        .HasConstraintName("FK_challenge_transaction_student_challenge");

                    b.Navigation("StudentChallenge");
